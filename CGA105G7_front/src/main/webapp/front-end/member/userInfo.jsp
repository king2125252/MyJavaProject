...
<%--           <input type="hidden" name="userNickname" value="<%=usersVO.getUserNickname()%>"> --%>
        ...
        <div id="alltogeter_scope_border">揪團總評分 : <input type="text" value="<%=usersVO.getAlltogetherScore()%>" readonly="readonly"
            ...
            <div id="update_border"for="update"><input type="button" value="修改" id="update">
            </div>
