    ...
    <input type="hidden" name="action" value="addMember">
        ...
        <div id="user_Birthday_border">
            <label for="user_Birthday">
                ...
                </div><input id="user_Birthday" type="date" name=userBrthday title=" 生日可以手動與選擇輸入" autofocus>
            </label>
        ...
        <div id="user_Address_border">
            <label for="user_Address">
                ...
                <input id="user_Address" type="text" name=userAddress placeholder="請輸入地址" title="地址必須由10~30字元的中文、英文、數字組成" autofocus>
            </label>
