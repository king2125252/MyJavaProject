...
<head>
  ...
  <link rel="website icon" href="/CGA105G7/front-end/images/bgremove_Logo.jpg">
...
<body>	<form id="index" name="index">
  
  
  <!-- nav start -->
  <nav class="navbar navbar-expand-lg navbar-light bg-cblue fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="/CGA105G7/front-end/index.html">
        <img src="/CGA105G7/front-end/images/bgremove_Logo.jpg" id="logo">
      </a>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="<%=request.getContextPath()%>/front-end/member/login.jsp" style="display:block" id=login> 登入</a>
...
<%-- "/CGA105G7/front-end/member/getPic.jsp?UserAccount='<%=usersVO.getUserAccount()%>'" --%>
          <li class="nav-item mx-3 user-info">
            <img src="/CGA105G7/front-end/images/user.png" alt="會員照片" class="user-pic">
            <ul class="bg-cblue info-list">
<%--             "<%=request.getContextPath()%>/front-end/member/userInfo.jsp " --%>
              <li id="info"><a href=" #" class="d-block info-item">會員基本資料</a></li>
              <li><a href="#" class="d-block info-item">我的行程</a></li>
<%--              
 				<%=request.getContextPath()%>/front-end/collection/collection.jsp --%>
			 <form id="Collection" name="Collection" ACTION="<%=request.getContextPath()%>/collectionServlet">
  ...
  <div class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="/CGA105G7/front-end/images/view1.jpeg" class="d-block w-100 slide-pic">
      </div>
      <div class="carousel-item">
        <img src="/CGA105G7/front-end/images/view2.jpeg" class="d-block w-100 slide-pic">
      </div>
      <div class="carousel-item">
        <img src="/CGA105G7/front-end/images/view3.jpeg" class="d-block w-100 slide-pic">
      </div>
    </div>
          ...
          <div class="coontainer p-3 overflow-auto" style="height: 300px;">
            <div class="row">
              <div class="col-2 p-2 pb-0">
                <img src="/CGA105G7/front-end/images/dog.jpeg" alt="會員照片" class="user-pic">
              </div>
              <div class="col-7 p-1">
  ...
  <article class="container-md">
    <div class="row justify-content-md-evenly text-center area-content">
      <a href="" class="col-2 fixed-w-h fade-area">
        <img src="/CGA105G7/front-end/images/north.jpeg" alt="北部" class="w-100 h-100 rounded">
        <div class="w-100 h-100 pic-text">北部</div>
      </a>
      <a href="" class="col-2 fixed-w-h fade-area">
        <img src="/CGA105G7/front-end/images/middle.jpg" alt="中部" class="w-100 h-100 rounded">
        <div class="w-100 h-100 pic-text">中部</div>
      </a>
      <a href="" class="col-2 fixed-w-h fade-area">
        <img src="/CGA105G7/front-end/images/south.jpg" alt="南部" class="w-100 h-100 rounded">
        <div class="w-100 h-100 pic-text">南部</div>
      </a>
      <a href="" class="col-2 fixed-w-h fade-area">
        <img src="/CGA105G7/front-end/images/east.jpg" alt="東部" class="w-100 h-100 rounded">
    ...
    <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
      <div class="col">
        <a href="#" class="card h-100 shadow-sm fade-area">
          <img src="/CGA105G7/front-end/images/hotel1.jpeg" class="card-img-top" alt="飯店圖片">
          <div class="card-body">
      ...
      <div class="col">
        <a href="#" class="card h-100 shadow-sm fade-area">
          <img src="/CGA105G7/front-end/images/hotel2.jpeg" class="card-img-top" alt="飯店圖片">
          <div class="card-body">
            <h5 class="card-title fw-bold text-truncate">XXX飯店</h5>
            <p class="card-text m-1">台北</p>
            <p class="card-text m-1">$ 10,000元起</p>
      ...
      <div class="col">
        <a href="#" class="card h-100 shadow-sm fade-area">
          <img src="/CGA105G7/front-end/images/hotel3.jpeg" class="card-img-top" alt="飯店圖片">
          <div class="card-body">
            <h5 class="card-title fw-bold text-truncate">XXX飯店</h5>
            <p class="card-text m-1">台北</p>
            <p class="card-text m-1">$ 10,000元起</p>
      ...
      <div class="col">
        <a href="#" class="card h-100 shadow-sm fade-area">
          <img src="/CGA105G7/front-end/images/hotel4.jpeg" class="card-img-top" alt="飯店圖片">
          <div class="card-body">
            <h5 class="card-title fw-bold text-truncate">XXX飯店</h5>
            <p class="card-text m-1">台北</p>
            <p class="card-text m-1">$ 10,000元起</p>
  ...
  <div class="container">
    ...
    <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
      <div class="col">
        <div class="card h-100 shadow-sm">
          <a href="#" class="fade-area">
            <img src="/CGA105G7/front-end/images/view1.jpeg" class="card-img-top" alt="飯店圖片">
          </a>
          <div class="card-body">
      ...
      <div class="col">
        <div class="card h-100 shadow-sm">
          <a href="#" class="fade-area">
            <img src="/CGA105G7/front-end/images/view2.jpeg" class="card-img-top" alt="飯店圖片">
          </a>
          <div class="card-body">
            <a href="#" class="a-style text-dark">
              <h5 class="card-title fw-bold text-truncate">
      ...
      <div class="col">
        <div class="card h-100 shadow-sm">
          <a href="#" class="fade-area">
            <img src="/CGA105G7/front-end/images/view3.jpeg" class="card-img-top" alt="飯店圖片">
          </a>
          <div class="card-body">
            <a href="#" class="a-style text-dark">
              <h5 class="card-title fw-bold text-truncate">
  ...
  <div class="container">
    ...
    <div class="row row-cols-1 row-cols-xs-2 row-cols-sm-2 row-cols-lg-4 g-3">
      <div class="col">
        <div class="card h-100 shadow-sm">
          <a href="#" class="fade-area">
            <img src="/CGA105G7/front-end/images/Logo.jpg" class="card-img-top" alt="飯店圖片">
          </a>
          <div class="card-body">
            <a href="#" class="a-style text-dark">
...
<%-- 	 <%   --%>
// 	 if (usersVO==null){
// 		 out.println("alert('bbb');");
// 	 }
// 	 if(usersVO!=null){
// 		 out.println("alert('aaa');");
// 		 	request.getSession().invalidate(); 
// 	  response.sendRedirect("/front-end/member/login.jsp");
// 		 }
<%--  %> --%>
//  });
loginout.addEventListener("click", function () {
